...
@Injectable()
export class AppTopPerformanceComponent extends DataAndChartTemplate  {
  displayedColumns = ['symbol', 'perf'];
  dataSource = new MatTableDataSource([]);

  displayedColumnsRef = ['symbol', 'ts_from','val_from','ts_to','val_to','perf'];
  ...
  updateData() {
    this.logic.getTopPerformance(this.source,this.from,this.to,this.base, (res) => {
      this.data = res;
